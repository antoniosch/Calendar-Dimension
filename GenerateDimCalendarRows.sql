...
WHERE DateKey IN ( SELECT MAX(DateKey) FROM #TT WHERE CYMonth = 5 AND DayNameNational='Mon' GROUP BY CYYear, CYMonth );
...
WHERE DateKey IN ( SELECT MIN(DateKey) FROM #TT WHERE CYMonth = 9 AND DayNameNational='Mon' GROUP BY CYYear, CYMonth );
